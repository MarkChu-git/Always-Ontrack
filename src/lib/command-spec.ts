...
export const AGENT_COMMAND_SPECS: readonly AgentCommandSpec[] = [
  ...
  spec({ path: 'task.resources', description: 'Download task resource archives.', fields: { ...jsonTaskSelector, out_dir: stringField('--out-dir') } }),
  ...
  spec({ path: 'pdf.task', description: 'Download task PDFs.', fields: { ...jsonTaskSelector, out_dir: stringField('--out-dir') } }),
  spec({ path: 'pdf.submission', description: 'Download submission PDFs.', fields: { ...jsonTaskSelector, out_dir: stringField('--out-dir') } }),
  spec({ path: 'submission.status', description: 'Read submission lifecycle status.', fields: oneTaskSelector }),
  spec({ path: 'submission.upload', description: 'Prepare or dispatch one submission.', risk: 'write', fields: { ...oneTaskSelector, files: stringArrayField('--file', true), trigger: stringField('--trigger'), comment: stringField('--comment'), confirm: booleanField('--confirm'), idempotency_key: stringField('--idempotency-key') } }),
  spec({ path: 'submission.upload_new_files', description: 'Prepare or attach evidence to an existing submission.', risk: 'write', fields: { ...oneTaskSelector, files: stringArrayField('--file', true), trigger: stringField('--trigger'), comment: stringField('--comment'), confirm: booleanField('--confirm'), idempotency_key: stringField('--idempotency-key') } }),
