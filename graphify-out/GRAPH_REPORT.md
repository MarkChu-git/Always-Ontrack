# Graph Report - watch-semantics  (2026-08-07)

## Corpus Check
- 104 files · ~130,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1726 nodes · 4188 edges · 99 communities (93 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `471400be`
...
Cohesion: 0.23
Nodes (31): contractAliasedArray(), contractAliasedValue(), contractRecord(), contractSafeText(), remoteContractFailure(), requiredContractPositiveInteger(), AgentTaskCatalogueItem, assertAuthoritativeTaskDefinitions() (+23 more)

### Community 1 - "SessionData"
Cohesion: 0.08
Nodes (41): handleDoctor(), readAgentFeedbackList(), readAgentFeedbackTarget(), authHeaders(), AuthSessionRefresh, buildErrorMessage(), DownloadResult, fetchOnTrack() (+33 more)

### Community 2 - "utils.ts"
Cohesion: 0.07
Nodes (56): downloadTaskResourceArtifacts(), taskIdentityJson(), taskResourceIdentity(), wrapAgentOutput(), StudentTaskRow, TaskSelector, buildPdfFilename(), buildTaskResourceFilename() (+48 more)

### Community 3 - "cli.ts"
Cohesion: 0.05
Nodes (70): agentSubmissionStatusInputFromSelector(), buildAgentSubmissionStatusOutput(), buildWatchSnapshot(), createNativeAgentExecutionEngine(), deriveUnitsFromProjects(), DIGITAL_LOGO_LINES, DoctorCheck, feedbackAuthor() (+62 more)
...
Cohesion: 0.13
Nodes (60): agentFeedbackListInputFromSelector(), applyLimit(), arrayLength(), claimConfirmedWrite(), createAuthenticatedApi(), getUnitTaskDefinitions(), handleAuthEnsure(), handleAuthMethod() (+52 more)
...
Cohesion: 0.17
Nodes (30): buildInboxFallbackTasksFromProjectDetails(), countTasksByStatus(), dedupeInboxTasks(), deriveDefaultSubmissionTrigger(), describeWatchEvent(), extractInboxProjectId(), flattenTasks(), handleInbox() (+22 more)

### Community 12 - "student-task-view.ts"
Cohesion: 0.05
Nodes (81): resolveSelectedStudentTask(), AgentPlanShowOutput, aliasValues(), buildAgentPlanShowOutput(), calendarDate(), nonNegativeInteger(), normalizePrerequisites(), own() (+73 more)
...
Cohesion: 0.10
Nodes (32): agentPlanDateSchema(), contractNonNegativeInteger(), hasOwnField(), validateAgentFeedbackWatchFrame(), assertAgentEnvelopeByteLimit(), AgentWatchDate, AgentWatchDateKind, agentWatchDateSchema (+24 more)
...
Cohesion: 0.15
Nodes (21): AGENT_SCHEMA_VERSION, AgentArtifact, AgentErrorCode, agentErrorEnvelope(), AgentFailureEnvelope, AgentNextAction, AgentOutputContext, AgentProtocolErrorOptions (+13 more)
...
Cohesion: 0.11
Nodes (23): AgentTasksListOutput, AgentFeedbackItem, AgentFeedbackListSource, AgentFeedbackTarget, AgentFeedbackTask, AgentFeedbackWatchFrame, booleanValue(), completeAgentEnvelopeBytes() (+15 more)
...
Cohesion: 0.26
Nodes (9): AgentProjectsListOutput, AgentProjectCapabilities, AgentProjectDirectoryItem, booleanValue(), buildAgentProjectsListOutput(), completeAgentEnvelopeBytes(), projectCapabilities(), projectDirectoryItem() (+1 more)
...
### Community 95 - "agent-contract.ts"
Cohesion: 0.36
...
## Knowledge Gaps
- **562 isolated node(s):** `name`, `version`, `description`, `license`, `type` (+557 more)
...
- **Should `SessionData` be split into smaller, more focused modules?**
  _Cohesion score 0.08003442340791739 - nodes in this community are weakly interconnected._
