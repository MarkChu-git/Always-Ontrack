...
## Corpus Check
- 146 files · ~209,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2083 nodes · 5274 edges · 102 communities (98 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `965f66c8`
...
Cohesion: 0.07
Nodes (56): handleLogin(), wrapAgentOutput(), downloadTaskResourceArtifacts(), readAgentTaskResources(), taskResourceIdentity(), TaskSummary, buildPdfFilename(), buildTaskResourceFilename() (+48 more)

### Community 3 - "handleInbox"
Cohesion: 0.17
Nodes (28): buildInboxFallbackTasksFromProjectDetails(), countTasksByStatus(), dedupeInboxTasks(), describeWatchEvent(), extractInboxProjectId(), flattenTasks(), handleInbox(), handleTasks() (+20 more)
...
Cohesion: 0.04
Nodes (49): AgentAuthStatus, agentFeedbackItemSchema, agentFeedbackListInputSchema, agentFeedbackMultilineTextSchema, agentFeedbackTextSchema, agentFeedbackWatchInputSchema, agentFeedbackWatchItemSchema, agentFeedbackWatchOptions (+41 more)

### Community 6 - "auto-login.ts"
Cohesion: 0.06
Nodes (50): asErrorMessage(), browserInstallHint(), BrowserLaunchPlan, BrowserStorageEntry, BrowserStorageState, candidateBrowserPaths(), ClaimedBrowserSessionState, clickDetectedMfaOption() (+42 more)
...
Cohesion: 0.15
Nodes (57): agentFeedbackListInputFromSelector(), claimConfirmedWrite(), handleAuthEnsure(), handleAuthMethod(), handleAuthStatus(), handleDiscover(), handleFeedbackCommand(), handleFeedbackList() (+49 more)
...
Cohesion: 0.05
Nodes (83): sanitizeAgentData(), buildAgentSubmissionStatusOutput(), ArtifactOutputOptions, ArtifactPathOptions, ArtifactSafetyError, assertCleanPathInput(), assertNoSymbolicLinkComponents(), assertSafeFilename() (+75 more)
...
Cohesion: 0.12
Nodes (23): AgentTasksListInput, AgentTasksListOutput, AgentTutorialsStatusInput, AgentTutorialsStatusOutput, agentTutorialsStatusOutputSchema, AgentProjectUnitSource, canonicalTutorialStatusUnit(), AgentProtocolError (+15 more)

### Community 13 - "auth-broker.ts"
Cohesion: 0.16
Nodes (15): CapturedSignIn, createOnTrackAuthBroker(), defaultDependencies(), OnTrackAuthBrokerDependencies, OnTrackAuthBrokerOptions, sessionFromCapture(), createSessionFromAccessToken(), AuthEnsureOptions (+7 more)
...
### Community 20 - "createNativeAgentCommands"
Cohesion: 0.21
...
### Community 22 - "promptTaskSelectorFromTaskList"
Cohesion: 0.13
Nodes (25): buildTaskSelectorArgs(), expandHomePath(), handleWelcome(), help(), panelBodyCode(), panelToneCode(), panelVisibleLength(), parseTaskSelectorTokens() (+17 more)
...
### Community 24 - "tui/auth.ts"
Cohesion: 0.15
Nodes (19): ssoRedirectUrl(), captureSsoCredentials(), classifySsoFallback(), SsoFallbackReason, resolveRelayUrl(), normalizeBaseUrl(), redactSensitiveText(), DEFAULT_TUI_AUTH (+11 more)
...
Cohesion: 0.11
Nodes (29): AgentFeedbackListInput, AgentFeedbackListOutput, AgentFeedbackWatchInput, AgentFeedbackItem, AgentFeedbackListSource, AgentFeedbackReadContext, AgentFeedbackTarget, AgentFeedbackTask (+21 more)
...
Cohesion: 0.14
Nodes (22): defaultDependencies(), readAuthStatus(), clearAllBrowserSessionState(), AcquiredSessionRefreshLock, acquireSessionRefreshLock(), clearSession(), getConfigRoot(), getSessionPath() (+14 more)
...
Cohesion: 0.06
Nodes (44): isFilesRequiredRejection(), SubmissionPdfState, App(), Command, dueBadge(), fuzzyMatch(), Header(), matches() (+36 more)
...
Cohesion: 0.16
Nodes (20): createNativeAgentExecutionEngine(), normalizeAgentCliError(), readAgentFeedbackList(), readAgentFeedbackTarget(), readAgentFeedbackWatch(), readAgentPlanShow(), readAgentProjectsList(), readAgentTasksList() (+12 more)
...
Cohesion: 0.18
Nodes (16): AgentPlanShowOutput, AgentWatchState, AGENT_REMOTE_READ_CONCURRENCY, mapWithConcurrency(), settleWithConcurrency(), settleMetadataReads(), makeWatchTaskKey(), WatchTaskState (+8 more)

### Community 55 - "cli.ts"
Cohesion: 0.06
Nodes (53): agentSubmissionStatusInputFromSelector(), applyLimit(), arrayLength(), buildWatchSnapshot(), deriveUnitsFromProjects(), DIGITAL_LOGO_LINES, DoctorCheck, feedbackAuthor() (+45 more)
...
Cohesion: 0.09
Nodes (28): AuthFailureKind, classifyAuthFailure(), migrateLegacySession(), OnTrackHttpError, CapturedLoginMaterial, finalizeCapturedLogin(), PairedCredentialRejectedError, sessionFromAccessTokenCapture() (+20 more)
...
### Community 71 - "status.ts"
Cohesion: 0.31
Nodes (8): DEFAULT_AUTH_MIN_TTL_SECONDS, ApplyStatusTriggerInput, ApplyStatusTriggerOutcome, applyStudentStatusTrigger(), StudentStatusTrigger, runSetStatus(), SetStatusOutcome, SetStatusRunner
...
Cohesion: 0.08
Nodes (40): engines, bun, client, expectedTools, transport, assertChildPath(), assertRegularTree(), createTuiCapture() (+32 more)
...
### Community 88 - "planner.ts"
Cohesion: 0.14
Nodes (22): buildPlannerViews(), buildTargetDateMutation(), dateFrom(), defaultDate(), gradeDateRow(), integerValue(), parseDateOnly(), personalDate() (+14 more)
...
Cohesion: 0.16
Nodes (24): BuildStudentTaskViewOptions, buildStudentTaskViews(), definitionsForProject(), definitionTargetGrade(), definitionTutorialStream(), embeddedDefinition(), enrolledTutorialStreams(), includeVisibility() (+16 more)
