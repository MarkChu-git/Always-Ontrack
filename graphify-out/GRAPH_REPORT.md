...
## Corpus Check
- 147 files · ~209,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2081 nodes · 5249 edges · 102 communities (98 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27f45abe`
...
9. `hasFlag()` - 33 edges
10. `createOnTrackAuthBroker()` - 32 edges
...
### Community 1 - "api.ts"
Cohesion: 0.07
Nodes (47): handleDoctor(), authHeaders(), AuthSessionRefresh, buildErrorMessage(), contentDispositionFilename(), extractRefreshCookieFromHeaders(), fetchOnTrack(), InvalidDownloadFormatError (+39 more)

### Community 2 - "utils.ts"
Cohesion: 0.07
Nodes (58): feedbackKind(), downloadTaskResourceArtifacts(), buildStudentTaskRows(), StudentTaskRow, TaskSelector, buildPdfFilename(), buildTaskResourceFilename(), colorize() (+50 more)

### Community 3 - "tui/auth.ts"
Cohesion: 0.15
Nodes (18): ssoRedirectUrl(), captureSsoCredentials(), classifySsoFallback(), SsoFallbackReason, resolveRelayUrl(), DEFAULT_TUI_AUTH, isLoginFailure(), LoginFailure (+10 more)
...
Cohesion: 0.06
Nodes (44): BrowserLaunchPlan, BrowserStorageEntry, BrowserStorageState, ClaimedBrowserSessionState, clickDetectedMfaOption(), collectCredentialScopes(), collectKnownMfaMethodOptions(), collectMfaSelectionOptions() (+36 more)
...
### Community 8 - "main"
Cohesion: 0.18
Nodes (43): buildInboxFallbackTasksFromProjectDetails(), countTasksByStatus(), describeWatchEvent(), flattenTasks(), handleAuthEnsure(), handleAuthMethod(), handleAuthStatus(), handleDiscover() (+35 more)
...
Cohesion: 0.05
Nodes (80): ArtifactOutputOptions, ArtifactPathOptions, ArtifactSafetyError, assertCleanPathInput(), assertNoSymbolicLinkComponents(), assertSafeFilename(), findExternalArtifactPaths(), inspectUploadFile() (+72 more)
...
Cohesion: 0.19
Nodes (12): CapturedSignIn, createOnTrackAuthBroker(), defaultDependencies(), OnTrackAuthBrokerDependencies, OnTrackAuthBrokerOptions, sessionFromCapture(), AutoLoginOptions, LoginCredentials (+4 more)
...
Cohesion: 0.05
Nodes (45): AuthMcpDependencies, configuredBaseUrl(), createAuthMcpServer(), defaultDependencies(), nextActionSchema, serveAuthMcp(), toolResponse(), ToolResult (+37 more)

### Community 20 - "handleLogin"
Cohesion: 0.18
Nodes (15): handleLogin(), buildAgentSubmissionPdfOutput(), buildAgentTaskPdfOutput(), taskResourceIdentity(), isHeadlessServerEnvironment(), openExternal(), parseSsoRedirectUrl(), resolveExternalOpenCommand() (+7 more)
...
Cohesion: 0.17
Nodes (12): candidateBrowserPaths(), clearAllBrowserSessionState(), clearBrowserSessionState(), expandSystemBrowserProfileCandidates(), extractCredentialsFromUrl(), extractRefreshCookieMaterial(), isLikelyChromiumProfileDir(), resolveBrowserLaunchPlan() (+4 more)
...
Cohesion: 0.13
Nodes (19): nonBlankStringValue(), numberValue(), stringValue(), toWhoAmIView(), WhoAmIView, bucketStatus(), daysUntil(), formatDue() (+11 more)
...
### Community 35 - "loadSession"
Cohesion: 0.48
Nodes (6): handleLogout(), readAuthStatus(), clearSession(), loadSession(), signOutEverywhere(), SignOutResult
...
Cohesion: 0.12
Nodes (22): App(), Command, dueBadge(), fuzzyMatch(), Header(), matches(), Mode, StatusPill() (+14 more)
...
Cohesion: 0.18
Nodes (24): agentSubmissionStatusInputFromSelector(), createNativeAgentExecutionEngine(), handleSubmissionCommand(), handleSubmissionStatus(), normalizeAgentCliError(), readAgentFeedbackList(), readAgentFeedbackTarget(), readAgentFeedbackWatch() (+16 more)
...
Cohesion: 0.10
Nodes (24): AgentSubmissionPdfInput, AgentSubmissionPdfOutput, AgentSubmissionStatusInput, AgentSubmissionStatusOutput, AgentTaskPdfInput, AgentTaskPdfOutput, AgentTaskPrerequisitesInput, AgentTaskPrerequisitesOutput (+16 more)
...
Cohesion: 0.09
Nodes (25): OnTrackHttpError, DEFAULT_AUTH_MIN_TTL_SECONDS, SubmissionPdfState, SubmissionUploadCompleted, SubmissionTrigger, redactSensitiveText(), PRODUCTION_SUBMIT_ACTIONS, SubmitActions (+17 more)

### Community 54 - "handleTaskStatus"
Cohesion: 0.25
Nodes (15): claimConfirmedWrite(), handlePlanCommand(), handlePlanReset(), handlePlanSetDates(), handleSubmissionUpload(), handleTaskStatus(), loadPlannerContext(), parseAgentFeedbackListSelector() (+7 more)

### Community 55 - "cli.ts"
Cohesion: 0.06
Nodes (66): applyLimit(), arrayLength(), buildTaskSelectorArgs(), buildWatchSnapshot(), dedupeInboxTasks(), deriveUnitsFromProjects(), DIGITAL_LOGO_LINES, DoctorCheck (+58 more)
...
Cohesion: 0.13
Nodes (21): AuthFailureKind, classifyAuthFailure(), createSessionFromAccessToken(), migrateLegacySession(), sessionUsability, CapturedLoginMaterial, finalizeCapturedLogin(), PairedCredentialRejectedError (+13 more)
...
### Community 69 - "handleNativeAgentCommand"
Cohesion: 0.33
...
Cohesion: 0.14
Nodes (18): ApplyStatusTriggerInput, ApplyStatusTriggerOutcome, applyStudentStatusTrigger(), isFilesRequiredRejection(), StudentTaskView, AccessTokenResponse, InboxTask, OnTrackUser (+10 more)
...
### Community 79 - "配对中继与 OnTrack 会话寿命研究（2026-08-24）"
Cohesion: 0.10
...
### Community 88 - "handleFeedbackWatch"
Cohesion: 0.18
Nodes (12): agentFeedbackListInputFromSelector(), feedbackAuthor(), feedbackMessage(), firstString(), formatDateTime(), handleFeedbackCommand(), handleFeedbackList(), handleFeedbackWatch() (+4 more)
...
### Community 92 - "agent-call-input.ts"
Cohesion: 0.43
...
### Community 98 - "cli-entry.ts"
Cohesion: 0.40
Nodes (3): CliEntryResolution, CliTerminalState, resolveCliEntry()

### Community 106 - "student-task-view.ts"
Cohesion: 0.05
Nodes (80): AgentPlanShowInput, AgentPlanShowOutput, aliasValues(), buildAgentPlanShowOutput(), calendarDate(), normalizePrerequisites(), own(), pairedArray() (+72 more)
...
- **Why does `client` connect `verify-package.ts` to `session.ts`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `withClient()` connect `session.ts` to `verify-package.ts`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **What connects `name`, `version`, `description` to the rest of the system?**
  _608 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `api.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.0655534941249227 - nodes in this community are weakly interconnected._
