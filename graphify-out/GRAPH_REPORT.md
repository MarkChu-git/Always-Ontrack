# Graph Report - submission-status  (2026-08-05)

## Corpus Check
- 87 files · ~109,359 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1193 nodes · 3060 edges · 65 communities (60 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15accba1`
...
8. `createAuthenticatedApi()` - 29 edges
9. `loadProjectsWithTaskMetadata()` - 28 edges
...
Cohesion: 0.15
Nodes (27): buildInboxFallbackTasksFromProjectDetails(), buildWatchSnapshot(), countTasksByStatus(), dedupeInboxTasks(), deriveDefaultSubmissionTrigger(), describeWatchEvent(), extractInboxProjectId(), filterProjectsForWatch() (+19 more)

### Community 1 - "api.ts"
Cohesion: 0.09
Nodes (40): handleDoctor(), authHeaders(), AuthSessionRefresh, buildErrorMessage(), DownloadResult, fetchOnTrack(), InvalidDownloadFormatError, InvalidJsonResponseError (+32 more)
...
Cohesion: 0.07
Nodes (59): StudentTaskRow, TaskSelector, buildPdfFilename(), buildTaskResourceFilename(), colorize(), COLORS_ENABLED, DEFAULT_DOWNLOAD_DIR, ExternalOpenCommand (+51 more)

### Community 4 - "agent-protocol.ts"
Cohesion: 0.13
Nodes (24): AGENT_SCHEMA_VERSION, AgentArtifact, AgentErrorCode, agentErrorEnvelope(), AgentNextAction, AgentOutputContext, AgentProtocolError, AgentProtocolErrorOptions (+16 more)
...
Cohesion: 0.10
Nodes (18): agentSubmissionStatusOutputSchema, AGENT_COMMAND_SPECS, AgentCommandRisk, COMMAND_SPEC_MAP, CommandInputType, getCommandSpec(), GROUPED_PATHS, jsonSchemaForFields() (+10 more)
...
Cohesion: 0.18
Nodes (12): AuthStatusView, createOnTrackAuthBroker(), defaultDependencies(), OnTrackAuthBrokerDependencies, OnTrackAuthBrokerOptions, sessionFromCapture(), AutoLoginOptions, captureSsoCredentials() (+4 more)
...
Cohesion: 0.13
Nodes (22): AgentBasePolicy, AgentCallRequest, AgentCommandManifest, AgentCommandPolicy, AgentExecutionEngineOptions, AgentExecutionEnvelope, AgentNonWritePolicy, AgentPolicyRuntime (+14 more)
...
Cohesion: 0.15
Nodes (52): claimConfirmedWrite(), createAuthenticatedApi(), getUnitTaskDefinitions(), handleAuthEnsure(), handleAuthStatus(), handleDiscover(), handleFeedbackCommand(), handleFeedbackList() (+44 more)
...
### Community 54 - "submission-lifecycle.ts"
Cohesion: 0.11
...
### Community 55 - "cli.ts"
Cohesion: 0.05
Nodes (71): agentSubmissionStatusInputFromSelector(), applyLimit(), arrayLength(), buildAgentSubmissionStatusOutput(), createNativeAgentExecutionEngine(), deriveUnitsFromProjects(), DIGITAL_LOGO_LINES, DoctorCheck (+63 more)

### Community 56 - "agent-commands.ts"
Cohesion: 0.06
Nodes (31): AgentAuthStatus, agentSingleTaskInputSchema, AgentSubmissionStatusInput, agentSubmissionStatusInputSchema, AgentSubmissionStatusOutput, agentTaskPrerequisiteSchema, AgentTaskPrerequisitesInput, agentTaskPrerequisitesInputSchema (+23 more)

### Community 57 - "student-task-view.ts"
Cohesion: 0.16
...
Cohesion: 0.17
Nodes (12): AuthFailureKind, classifyAuthFailure(), createSessionFromAccessToken(), OnTrackHttpError, AccessTokenResponse, CredentialSource, OnTrackUser, TaskBatchSelector (+4 more)

### Community 61 - "OnTrackAuthBroker"
Cohesion: 0.33
...
### Community 63 - "TaskSummary"
Cohesion: 0.67
Nodes (3): StudentTaskView, TaskDefinitionSummary, TaskSummary
...
- **Should `api.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.08792792792792793 - nodes in this community are weakly interconnected._
